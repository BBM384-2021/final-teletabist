...
mix
.webpackConfig({module: {rules: [{ test: /\.scss$/, loader: "sass-loader", options: {additionalData: '@import "resources/scss/_variables.scss";'}}]}})
.options({hmrOptions:{port:8001}})
.sass(path.resolve(scssPath,"style.scss"), cssOut).js(path.resolve(jsPath, 'main.js'), jsOut).vue({version:2});